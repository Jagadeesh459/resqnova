...
const PERSONAS: PersonaInfo[] = [
  ...
  },
  {
    ...
    icon: Radio,
    description: 'Tactical field unit commander receiving prioritized citizen extractions, QAOA dispatch corridors, and squad deployment telemetry.',
    landingPage: '/rescue',
    keyFeatures: [
      'Live SOS triage queue with medical urgency',
      'QAOA quantum dispatch corridors',
  ...
  },
  {
    ...
    icon: Building2,
    description: 'Shelter warden managing refugee intake, available bed headroom, food/water stocks, and QUBO evacuation streams.',
    landingPage: '/shelter',
    keyFeatures: [
      'Bed headroom & capacity tracker',
      'Food, water, and infant formula stocks',
      'Evacuee intake registration',
      'QUBO stream coordination',
    ],
  },
  {
    role: 'admin',
    ...
    icon: ShieldAlert,
    description: 'Supreme command authority overseeing all agencies, quantum pre-positioning algorithms, AI triage, and citywide infrastructure status.',
    landingPage: '/dashboard',
    keyFeatures: [
      'All 11 command modules and GIS tactical layers',
      'Quantum QAOA resource optimization',
